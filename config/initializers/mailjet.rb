...
Mailjet.configure do |config|
  config.api_key = Rails.application.credentials[:public_key_mailjet]
  config.secret_key = Rails.application.credentials[:secret_key_mailjet]
  config.default_from = 'thehackingproject.lille@outlook.fr'
